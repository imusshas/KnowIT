...
import com.sudipto_fahad.knowit.data.ChatData
...
class ChatViewModel: ViewModel() {
    ...
    private fun getResponse(prompt: String) = viewModelScope.launch {
    ...
    private fun getResponseWithImage(prompt: String, bitmap: Bitmap) = viewModelScope.launch {
